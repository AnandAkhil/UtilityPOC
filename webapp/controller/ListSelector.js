sap.ui.define([
		...
		return BaseObject.extend("energymeterreading.test.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias energymeterreading.test.controller.ListSelector
			 */
			 ...
			 * @return {energymeterreading.test.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
